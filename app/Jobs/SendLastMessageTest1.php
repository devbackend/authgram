 ...
 */
class SendLastMessageTest1 extends AbstractQueueJob {
	/** @var string */
	private $userId;
		...
		try {
			$telegram->sendMessage([
				...
				'text'                     => implode("\n", [
					...
					'Проект AuthGram развивался без малого два года. За это время мы многого достигли благодаря вам: подключили более 100 приложений, авторизовали 50 с небольшим тысяч человек, обработали 150 000 сообщений, получили 1 000 0000 запросов на авторизацию.',
