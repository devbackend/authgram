...
<?php if (false === Auth::check()): ?>
	<p>
		Для того, чтобы добавить виджет на свой сайт, вам необходимо авторизоваться.
		Сделать это вы можете, используя наш виджет. Нажмите кнопку "Войти через Telegram" для получения кода и полсе отправьте этот код боту AuthGramBot при помощи команды /i &laquo;Полученный код&raquo;
	</p>
